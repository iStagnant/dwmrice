...
vim.api.nvim_create_autocmd(
  'BufWritePost',
  { pattern = { 'Xresources', 'Xdefauls', 'xresources', 'xdefauls'}, command = '!xrdb %' }
)
-- When shortcut files are updated, renew zsh and lf configs with new material
vim.api.nvim_create_autocmd(
  'BufWritePost',
  { pattern = { 'bm-files', 'bm-dirs' }, command = '!shortcuts' }
)
